...
const {
  handleStripeWebhook,
} = require("./controllers/stripe/stripe-webhook.controller");
app.post(
  "/api/stripe/webhook",
...
app.use((req, res, next) => {
  if (
    ...
    return next(); // Skip JSON parsing for multipart upload / Stripe webhook
  }
...
app.use("/api/stripe", require("./routes/stripe/stripe.routes"));
app.use("/api/onboarding", require("./routes/onboarding/onboarding.routes"));
app.use("/api/admin", require("./routes/admin/admin.routes"));
app.use("/api/public/visitor-sign-in", require("./routes/public/visitor-sign-in.routes"));
app.use("/api/public/leads", require("./routes/public/leads.routes"));
