...
const updateFacilityProfileValidator = [
  ...
  body("residentCapacityLimit")
    .optional()
    .isInt()
    .withMessage("Resident capacity limit must be an integer")
    .isIn([6, 7, 8])
    .withMessage("Resident capacity limit must be 6, 7, or 8")
    .toInt(),
];
...
/** Super Admin bulk resident capacity (6|7|8) for an organization's facilities */
const bulkResidentCapacityValidator = [
  body("tenantId")
    .notEmpty()
  ...
  body("residentCapacityLimit")
    .notEmpty()
    .withMessage("residentCapacityLimit is required")
    .isInt()
    .withMessage("Resident capacity limit must be an integer")
    .isIn([6, 7, 8])
    .withMessage("Resident capacity limit must be 6, 7, or 8")
  ...
  body("selectAll")
    .optional()
    .isBoolean()
    .withMessage("selectAll must be a boolean")
    .toBoolean(),
  body("facilityIds")
    .optional()
    .isArray()
    .withMessage("facilityIds must be an array"),
  body("facilityIds.*")
    .optional()
    .isUUID()
    .withMessage("Each facilityId must be a valid UUID"),
];
