-- NOTE: Legacy/out-of-order migration in this repository history.
-- The baseline migration that creates `tenants` runs later, so this migration
-- cannot be replayed on a fresh shadow DB. Newer migrations cover this schema.
SELECT 1;
/*
